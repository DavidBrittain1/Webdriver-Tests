...
namespace NFocusDemo.eCommerce_Project
{
    internal class eCommerce 
    {
        ...
        {       
            ...
            var parseInitialPrice = Convert.ToDouble(p);
            double discount = parseInitialPrice * 0.15;
            double price = parseInitialPrice - discount;
            Thread.Sleep(2000);
        ...
        public void checkout()
        {
            ...
            Assert.That(receiptTable.Text.Contains(receiptNumberPaper), "receipt numbers match");
